  ...
  constructor(){
    ...
    this.regions=[
      ...
      {id:"frostHighlands",name:"Frostleaf Highlands",thai:"ที่ราบสูงใบเยือกแข็ง",level:"Lv.42–60",cx:0,cz:-31,halfX:18,halfZ:16,color:[.53,.70,.72,1],
       mobs:["frostMoth","iceGolem"],boss:"frostGuardian"}
    ];
...
try{
  ...
  const state={
    ...
    attackCd:0,skillCd:0,skill2Cd:0,rollCd:0,target:null,lockedTarget:null,autoCombat:false,combatControlsHidden:false,autoSkill:true,autoLoot:true,autoTimer:0,autoSkillTimer:0,autoAnchor:null,autoRange:14,
